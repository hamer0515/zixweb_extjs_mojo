package ZixWeb::BookMgr::Hist::cost_bfee;
...
sub cost_bfee {
    ...
    unless ($tag) {
        ...
        my $sql =
    "select id, c, p, bi, ys_id, ys_type, j, d, period, rownumber() over() as rowid from book_$book $p->{condition}";
