package ZixWeb::BookMgr::Book::blc;
...
#                      },
#    next_page      => 1,
#    params         => "&fir=bfj_acct&sec=zjbd_type&thi=e_date&fou=period",
#    period         => undef,
#    prev_page      => 1,
#    sec            => "zjbd_type",
#    thi            => "e_date",
...
sub blc {
    ...
    unless ($tag) {
        ...
        my $sql =
    "select $fields, sum(j) as j, sum(d) as d, rownumber() over() as rowid from sum_blc $condition group by $fields";
