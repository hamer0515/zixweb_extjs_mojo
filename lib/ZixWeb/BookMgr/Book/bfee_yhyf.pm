package ZixWeb::BookMgr::Book::bfee_yhyf;
...
#                          period => "2013-03-25",
#                          rowid => 1,
#                          zjbd_date => "2013-04-10",
#                          zjbd_type => "\x{4E2D}\x{884C}\x{4EE3}\x{6536}\x{901A}\x{9053}              ",
#                        },
#                        ...
#                      ],
#    fir            => "bfj_acct",
...
sub bfee_yhyf {
    ...
    unless ($tag) {
        ...
        my $sql =
    "select $fields, sum(j) as j, sum(d) as d, rownumber() over() as rowid from sum_bfee_yhyf $condition group by $fields";
