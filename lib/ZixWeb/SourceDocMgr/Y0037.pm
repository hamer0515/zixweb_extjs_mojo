package ZixWeb::SourceDocMgr::Y0037;
...
sub y0037 {
    ...
    my $fields = [
        ...
        'wlzj_type',        'p',
        'fp',               'period',
        'zjbd_date_out_bj', 'zjbd_date_in_1',
        'zjbd_date_in_2',   'zjbd_date_in_3',
        'tx_date',          'ssn',
        'c',                'cust_proto',
        'bfee_1_back',      'bfee_2_back',
        'bfee_3_back',      'cwwf_bfee_1_back',
        'cwwf_bfee_2_back', 'cwwf_bfee_3_back',
        'cc_bfee_1_back',   'cc_bfee_2_back',
        'cc_bfee_3_back',   'cwws_cfee_back',
        'cfee_back',        'tx_amt'
    ];
            ...
            $p = $self->params(
                {
                    ...
                    cfee_back => [
                        ...
                        'cfee_from_back', $data->{cfee_back_to},
                        'cfee_back_to'
                    ],
                    cc_bfee_1_back => [
                        0,                     $data->{cc_bfee_1_back_from},
                        'cc_bfee_1_back_from', $data->{cc_bfee_1_back_to},
                        'cc_bfee_1_back_to'
                    ],
                    cc_bfee_2_back => [
                        0,                     $data->{cc_bfee_2_back_from},
                        'cc_bfee_2_back_from', $data->{cc_bfee_2_back_to},
                        'cc_bfee_2_back_to'
                    ],
                    cc_bfee_3_back => [
                        0,                     $data->{cc_bfee_3_back_from},
                        'cc_bfee_3_back_from', $data->{cc_bfee_3_back_to},
                        'cc_bfee_3_back_to'
                    ],
                    tx_amt => [
                        0,             $data->{tx_amt_from},
