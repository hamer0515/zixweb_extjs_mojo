package ZixWeb::SourceDocMgr::Y0031;
...
sub y0031 {
    ...
    my $fields = [ 'bfj_acct', 'bi', 'fp', 'p',
					'zjbd_date_out', 'tx_date', 'cn', 
					'c', 'comm', 'rp_bfee', 'cc_bfee', 'cc_cwwf_bfee'
				 ];
            ...
            $p = $self->params(
                {
                    ...
                    rp_bfee => [
                        0,           $data->{rp_bfee_from},
                        'rp_bfee_from', $data->{rp_bfee_to},
                        'rp_bfee_to'
                    ],
                    cc_bfee => [
                        0,           $data->{cc_bfee_from},
                        'cc_bfee_from', $data->{cc_bfee_to},
                        'cc_bfee_to'
                    ],
                    cc_cwwf_bfee => [
                        0,           $data->{cc_cwwf_bfee_from},
                        'cc_cwwf_bfee_from', $data->{cc_cwwf_bfee_to},
                        'cc_cwwf_bfee_to'
                    ],
                    status      => 1,
                    flag        => $data->{flag},
