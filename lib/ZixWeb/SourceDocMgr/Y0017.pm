package ZixWeb::SourceDocMgr::Y0017;
...
sub y0017 {
    ...
    my $fields = [
        'bfj_acct_1',   'bfj_acct_2',       'bfj_acct_bj',      'wlzj_type',    'bi',     'p',
        'cust_proto',   'zjbd_date_in_1',   'zjbd_date_in_2',   'zjbd_date_out','tx_date', 'c',
        'bfee','bfee_1','bfee_2','cfee',    'psp_amt',          'psp_c'
    ];
