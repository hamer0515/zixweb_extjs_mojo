package ZixWeb::SourceDocMgr::Y0013;
...
sub y0013 {
    ...
    my $fields = [ 'bfj_acct', 'zjbd_type', 'zjbd_date_out', 'zhgl_fee' ];
            ...
            $p = $self->params(
                {
                    ...
                    zhgl_fee => [
                        0,               $data->{zhgl_fee_from},
                        'zhgl_fee_from', $data->{zhgl_fee_to},
                        'zhgl_fee_to'
                    ],
                    status      => 1,
                    flag        => $data->{flag},
