...
sub add {
    ...
    # 原始凭证内容
    my $dict = {
        '0001' => [qw/bfj_acct zjbd_date_in zyzj_acct zjbd_date_out zjhb_amt zyzj_bfee memo/],
        ...
        '0015' => [qw/bfj_acct_in zjbd_date_in bfj_acct_out zjbd_date_out zjhb_amt bfj_bfee memo/],
        '0018' => [qw/bfj_acct_bj zjbd_date_in tx_amt c memo/],
        '0054' => [qw/zyzj_acct bi zjbd_date_in c lfee tx_date_from tx_date_to meno/],
