package ZixWeb::BookMgr::Book::txamt_yhyf;
...
#  data           => [
#                      {
#                        bfj_acct => "\x{5317}\x{4EAC}\x{94F6}\x{884C}\x{4E0A}\x{6D77}\x{5206}\x{884C}\x{8425}\x{4E1A}\x{90E8}-00130630500120109167292",
#                        d => "100.00",
#                        j => "100.00",
#                        period => "2013-04-16",
#                        rowid => 1,
#                        zjbd_date => "2013-04-16",
#                        zjbd_type => "\x{5EFA}\x{884C}\x{4EE3}\x{6536}\x{901A}\x{9053}              ",
#                      },
#                      ...
#                    ],
#  fir            => "bfj_acct",
...
sub txamt_yhyf {
    ...
    unless ($tag) {
        ...
        my $sql =
    "select $fields, sum(j) as j, sum(d) as d, rownumber() over() as rowid from sum_txamt_yhyf $condition group by $fields";
