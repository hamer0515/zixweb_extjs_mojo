package ZixWeb::BookMgr::Hist::bfee_zqqr;
...
sub bfee_zqqr {
    ...
    unless ($tag) {
        ...
        my $sql =
    "select id,bi,fp,tx_date, ys_id, ys_type, j, d, period, rownumber() over() as rowid from book_$book $p->{condition}";
