package ZixWeb::BookMgr::Hist::bfee_yhyf;
...
#                      ...
#                    },
#  book           => "\x{5E94}\x{4ED8}\x{94F6}\x{884C}-\x{5DF2}\x{6838}\x{5E94}\x{4ED8}\x{94F6}\x{884C}\x{624B}\x{7EED}\x{8D39}",
#  count          => 545,
#  d_from         => undef,
#  d_to           => undef,
#  data           => [
...
#                        zjbd_type => "\x{6C11}\x{751F}\x{94F6}\x{8054}\x{4EE3}\x{6536}\x{901A}\x{9053}        ",
#                      },
#                      ...
#                    ],
#  id             => undef,
