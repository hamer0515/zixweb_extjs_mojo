...
sub y0087 {
	...
	my $sql =
"select id, bi, bfj_acct_bj, tx_amt, lc_amt, flag, period, clear_date, rownumber() over(order by id desc) as rowid from yspz_0087 $p->{condition}"
	  ;
