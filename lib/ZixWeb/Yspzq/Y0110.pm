...
sub y0110 {
	...
	my $sql =
"select id, bi, bfj_acct_bj, tx_amt, lc_amt, flag, period, clear_date, rownumber() over(order by id desc) as rowid from yspz_0110 $p->{condition}"
	  ;
