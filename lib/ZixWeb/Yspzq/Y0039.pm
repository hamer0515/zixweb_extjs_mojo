...
sub y0039 {
	...
	my $sql =
"select id, bi, bfj_acct_bj, tx_amt, sc_amt, flag, period, clear_date, rownumber() over(order by id desc) as rowid from yspz_0039 $p->{condition}"
	  ;
