...
sub y0119 {
	...
	my $sql =
"select id, bi, bfj_acct_bj, tx_amt, sc_amt, flag, period, clear_date, rownumber() over(order by id desc) as rowid from yspz_0119 $p->{condition}"
	  ;
