package ZixWeb::SourceDocMgr::Y0024;
...
sub y0024 {
	...
	my $fields = [
		'bfj_acct_bj',      'bfj_acct',      'bi',             'p', 'period',
		'zjbd_date_out_bj', 'zjbd_date_out', 'tx_date',        'ssn',
		'c',                'wqr_c',         'cust_proto',     'cfee',
		'cfee_back',        'cwws_cfee',     'cwws_cfee_back', 'bfee',
		'tx_amt'
	];
